  ...
  return (
    <div className="lightbox" onClick={onClose}>
      <div className="lightbox__header">
        <span className="lightbox__sender">Image</span>
      ...
      <div className="lightbox__img-wrap" onClick={(e) => e.stopPropagation()}>
        <img className="lightbox__img" src={src} alt="" />
      </div>
      <div className="lightbox__footer">
        <a className="lightbox__action" href={src} download onClick={(e) => e.stopPropagation()}>Download</a>
      </div>
    </div>
  );
}
